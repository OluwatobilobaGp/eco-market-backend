...
# Simple SQLite for local dev - swap for Postgres in production.
DATABASES = {
    'default': {
...
# ---- CORS ----
# Dev-friendly default: allow all origins. Lock this down to your real
# domains (CORS_ALLOWED_ORIGINS = [...]) before shipping to production.
